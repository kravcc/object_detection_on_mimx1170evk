...
extern "C" void BOARD_ENETFlexibleConfigure(enet_config_t *config)
{
#if BOARD_NETWORK_USE_100M_ENET_PORT
...
static void stack_init(void *arg)
{
	...
	// This function could not be executed with other initializations in main
	// because of the following conflict with threads
...
int main(void)
{
	// Initialization of all required pins and components
    BOARD_ConfigMPU();
    BOARD_InitBootPins();
    BOARD_BootClockRUN();
